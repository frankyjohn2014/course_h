...
class PostRes(resources.ModelResource):
    ...
    class Meta:
        model = Post
        fields = ('id','title','descr_post','time_videos','quantity_videos','time_add','language_videos','picture_post','desc_large','site',"downoad_material_href","zip_files_href","company_name")
